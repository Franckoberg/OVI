...
<!-- <input id="file" type="file" multiple /> <div id="prev"></div> -->
	...
	<div class="container">
		<h1>Mise a jour de profil</h1>

		<div class="row">
			<!-- left column -->
			<form class="form-horizontal" action="<?php echo base_url('admin/updateProfil');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data"> 
				<div class="col-md-3">
				...
				<div class="col-md-9 personal-info">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputNom" id="inputNom" value="<?php echo $key->nom ?>" placeholder="Nom" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputPrenom" id="inputPrenom" value="<?php echo $key->prenom ?>" placeholder="Prenom" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<textarea class="form-control" name="inputsante" id="inputsante" value="<?php echo $key->maladie ?>" required> <?php echo $key->maladie ?> </textarea>
					...
					<div>
					    <input id="celi-stat" name="_status_matri" type="radio" value="<?php echo $key->status_matrimonial ?>" required/>
					    <input name="_status-m" type="hidden" value="on" />
					    <label for="celi-stat">C&eacutelibataire</label>
					 
					    <input id="mari-stat" name="_status_matri" type="radio" value="<?php echo $key->status_matrimonial ?>" required/>
					    <input name="_status-m" type="hidden" value="on" />
					    <label for="mari-stat">Mari&eacute</label>
					 
					    <input id="fian-stat" name="_status_matri" type="radio" value="<?php echo $key->status_matrimonial ?>" required/>
					    <input name="_status-m" type="hidden" value="on" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputProfession" id="inputProfession" placeholder="Profession" required value="<?php echo $key->profession ?>" /> 
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputTelephone_p" id="inputTelephone_p" value="<?php echo $key->telephone ?>" placeholder="Telephone" required /> 
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputAdresse_p" id="inputAdresse_p" value="<?php echo $key->adresse ?>" placeholder="Adresse" required /> 
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputEmail_p" id="inputEmail_p" value="<?php echo $key->email ?>" placeholder="Email" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputpersapp" id="inputpersapp" value="<?php echo $key->ugpersonne_nom ?>" placeholder="Nom de la (les) personne(s)" required />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputTelephone_ua" id="inputTelephone_ua" value="<?php echo $key->ugtelephone_a ?>" placeholder="Telephone" required />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputTelephone_ub" id="inputTelephone_ub" value="<?php echo $key->ugtelephone_b ?>" placeholder="Telephone" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputAdresse_uc" id="inputAdresse_uc" value="<?php echo $key->ugadresse ?>" placeholder="Adresse" required />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="inputEmail_u" id="inputEmail_u"  placeholder="Email" value="<?php echo $key->ugemail ?>" />
