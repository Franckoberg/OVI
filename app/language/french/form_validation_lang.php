...
$lang['ckeck_format_nom_p']            	   	   = "Le nom peut contenir que des caractères alphabetique Ex.: (Bergele)..";
$lang['ckeck_format_nom_p_n']            	   = "Le nom peut contenir que des caractères alphabetique Ex.: (Bergele)..";
$lang['ckeck_format_nom']            	   	   = "Le nom peut contenir que des caractères alphabetique Ex.: (Bergele)..";
$lang['ckeck_format_prenom']            	   = "Le prenom peut contenir que des caractères alphabetique Ex.: (Franck)..";
$lang['ckeck_format_telephone']          	   = "Veuillez saisir un numero de télepone valide Ex.: (40186048).";
$lang['ckeck_format_telephone_ua']         	   = "Veuillez saisir un numero de télepone valide Ex.: (40186048).";
$lang['ckeck_format_telephone_ub']         	   = "Veuillez saisir un numero de télepone valide Ex.: (40186048).";
$lang['ckeck_format_telephoneA']          	   = "Veuillez saisir un numero de télepone valide Ex.: (40186048).";
$lang['ckeck_format_telephoneB']          	   = "Veuillez saisir un numero de télepone valide Ex.: (40186048).";
$lang['ckeck_sexe_found']          	  		   = "Le sexe est obligatoire";
$lang['ckeck_date_naissance_found']            = "Le date de naissance est obligatoire format.: jour/mois/anne";
$lang['ckeck_goupesanguin_found']              = "Le groupe sanguin est obligatoire.";
$lang['is_fonction_valide']             	   = "Veuillez choisir une fonction valide la personne.";
$lang['is_date_naissance_valide']              = "La date est incorrect.";
$lang['check_if_email_exists']            	   = "Cet {field} est déjà utilisé pour un autre compte.";
$lang['check_if_email_exists_']            	   = "Cet {field} est déjà utilisé pour un autre compte.";
$lang['is_question_valid']            	   	   = "La {field} est requise.";

// $lang['ckeck_format_sexe']              	   = "Le champ {field} peut contenir que des caractères alphabetique.";
// $lang['ckeck_sexe_valide']             	   = "Le champ {field} peut contenir que des caractères alphanumériques, des caractères de soulignement et des traits d'union.";
